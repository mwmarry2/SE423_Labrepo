...
void main(void)
{
    ...
    GPIO_SetupPinOptions(16, GPIO_INPUT, GPIO_PUSHPULL);
...
{
    if (songcount>48){
        GPIO_SetupPinMux(16, GPIO_MUX_CPU1, 0); //PWM Pin!
        GpioDataRegs.GPACLEAR.bit.GPIO16 = 1;
    }else{
        EPwm9Regs.TBPRD = happybirth[songcount];
        songcount++;
    }
